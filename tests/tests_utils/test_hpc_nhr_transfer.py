...
def test_hpc_connector_transfer_file(hpc_nhr_data_transfer, path_batch_script_empty):
    ...
    test_hpc_file_path = join(hpc_nhr_data_transfer.project_root_dir, BATCH_SCRIPT_EMPTY)
...
def _test_hpc_connector_transfer_dir(hpc_nhr_data_transfer, path_dummy_workspace_data_dir):
    ...
    test_hpc_dir_path = join(hpc_nhr_data_transfer.project_root_dir, ID_WORKSPACE)
