...
process ocrd_skimage_binarize_2 {
    ...
    script:
        """
        ocrd-skimage-binarize -m ${mets_file} -I ${input_file_group} -O ${output_file_group} -p '{"method": "li"}'
        """
}
...
process ocrd_cis_ocropy_segment_5 {
    ...
    script:
        """
        ocrd-cis-ocropy-segment -m ${mets_file} -I ${input_file_group} -O ${output_file_group} -p '{"level-of-operation": "page"}'
        """
}
