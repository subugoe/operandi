...
workflow {
    main:
        ...
        ocrd_fileformat_transform(ocrd_calamari_recognize.out[0], ocrd_calamari_recognize.out[1], "OCR-D-OCR", "OCR-D-ALTO")
        merging_mets(ocrd_fileformat_transform.out[0], ocrd_fileformat_transform.out[1])
}
