...
process ocrd_calamari_recognize_7 {
    ...
    script:
        """
        ${params.env_wrapper_cmd_step7} ocrd-calamari-recognize -U ${params.mets_socket_path} -w ${params.workspace_dir} -m ${mets_path} --page-id ${page_range} -I ${input_group} -O ${output_group} -p '{"checkpoint_dir": "gt4histocr"}'
        """
}
