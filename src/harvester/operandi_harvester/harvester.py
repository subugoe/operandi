...
from .harvester_utils import build_vd18_remote_url, load_vd18_data, save_vd18_data
from .constants import USE_WORKSPACE_FILE_GROUP, WAIT_TIME_BETWEEN_SUBMITS
...
class Harvester:
    ...
    def start_harvesting(self, limit: int = 0):
        ...
        for vd18_ppn_id in self.vd18_data:
