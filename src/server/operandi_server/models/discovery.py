...
class PYDiscovery(BaseModel):
    ...
    cuda_version: str = Field(default="Cuda version not detected", description="Major/minor version of CUDA")
    has_ocrd_all: bool = Field(default=False, description="Whether deployment is based on ocrd_all")
